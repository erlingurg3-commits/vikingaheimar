...
create policy cruise_sales_leads_update_authenticated_v4
...
create policy cruise_sales_activities_update_authenticated_v4
...
create policy cruise_sales_tasks_update_authenticated_v4
